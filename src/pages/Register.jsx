...
import { Eye, EyeOff, Mail, Lock, Wallet, User, ArrowRight } from 'lucide-react';
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="appearance-none relative block w-full px-3 py-3 border border-gray-300 dark:border-brandDark-600 placeholder-gray-500 dark:placeholder-gray-400 text-gray-900 dark:text-white bg-white dark:bg-brandDark-800 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 focus:z-10 sm:text-sm"
            ...
            <div>
              ...
              <input
                ...
                type="text"
                className="appearance-none relative block w-full px-3 py-3 border border-gray-300 dark:border-brandDark-600 placeholder-gray-500 dark:placeholder-gray-400 text-gray-900 dark:text-white bg-white dark:bg-brandDark-800 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 focus:z-10 sm:text-sm font-mono"
